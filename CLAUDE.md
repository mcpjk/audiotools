...
- **WHAT SQUARING THE SECTIONS COSTS, MEASURED IN BOTH DIRECTIONS. Read this
  ...
  (2) **The throat-floor boundary is less tight than it was.** Over nine
  station counts the floored answer measured 0.507-0.552 mm before and
  0.516-0.757 mm now, because the near-throat gap profile opens slightly
  faster. The rule still works — the RAW answer changes sign across those
  counts (+0.010 to -0.241 mm) while the floored one never leaves
  [floor, floor + 0.3] — but do not quote the old 0.015 mm spread.
...
- **THE SHIPPED THROAT-FIFTH BOW IS OVER-TIGHT AT THE DEFAULTS, and squaring
  ...
  So the owner's "throat fifth almost every time" habit needs revisiting at
  the current defaults: either widen the window, or solve the depth to 360.8
  (dL 25.5 -> 11.1 mm) so there is less to buy back.
