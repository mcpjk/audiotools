...
import {
  speedOfSound, hypexR, hypexDrDx, hypexFlareRate, hypexLengthForRatio,
  tractrixPoints, tractrixAtX,
} from "./horn-model.js";

// The physics lives in ./horn-model.js — no React, no palette — so that
// scripts/test-horn.mjs can import it under node and check it against closed
// forms. Keep it that way; see the model comment at the top of that file.
